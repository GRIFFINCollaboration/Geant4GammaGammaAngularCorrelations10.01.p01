...
#include "G4NuclearLevel.hh" // Evan Rand
...
public:
  ...
  // Evan Rand  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  inline G4double GetLevelEnergy () {return _levelEnergy;};
...
private:
  ...
  std::vector<G4double> _a2;
  std::vector<G4double> _a4;
  std::vector<G4double> _a6;
  std::vector<G4double> _a8;
  std::vector<G4double> _a10;
